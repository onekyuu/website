      ...
      <ContentContainer>
        <section className="flex flex-col-reverse lg:flex-row items-center justify-between py-4 lg:py-12">
          <div className="flex flex-col font-bold text-4xl/11 md:text-5xl/17 lg:text-7xl/21 gap-4 mt-8 lg:mt-0 lg:w-1/2">
            <span className="text-[var(--color-gray-900)] dark:text-[var(--color-gray-50)] text-center lg:text-start">
            ...
            <span className="text-lg/6 lg:text-xl/7 mt-4 lg:mt-8 text-center lg:text-start font-light text-[var(--color-gray-600)] dark:text-[var(--color-gray-300)]">
              {t("Home.introduce")}
            </span>
