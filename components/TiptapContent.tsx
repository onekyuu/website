    ...
    editorProps: {
      attributes: {
        class: cn(
          ...
          // 标题样式
          "[&_h1]:text-3xl [&_h1]:md:text-4xl [&_h1]:lg:text-5xl [&_h1]:font-bold [&_h1]:text-[var(--color-gray-900)] [&_h1]:dark:text-[var(--color-gray-50)] [&_h1]:mt-8 [&_h1]:mb-4",
          "[&_h2]:text-2xl [&_h2]:md:text-3xl [&_h2]:lg:text-4xl [&_h2]:font-bold [&_h2]:text-[var(--color-gray-900)] [&_h2]:dark:text-[var(--color-gray-50)] [&_h2]:mt-6 [&_h2]:mb-3",
          "[&_h3]:text-xl [&_h3]:md:text-2xl [&_h3]:lg:text-3xl [&_h3]:font-semibold [&_h3]:text-[var(--color-gray-900)] [&_h3]:dark:text-[var(--color-gray-50)] [&_h3]:mt-5 [&_h3]:mb-2",
          "[&_h4]:text-lg [&_h4]:md:text-xl [&_h4]:lg:text-2xl [&_h4]:font-semibold [&_h4]:text-[var(--color-gray-800)] [&_h4]:dark:text-[var(--color-gray-100)] [&_h4]:mt-4 [&_h4]:mb-2",
          // 段落样式
          ...
          "[&_ol]:[counter-reset:item]", // 修复：使用正确的语法
          // 无序列表项样式
          ...
          "[&_ul>li]:before:content-['•'] [&_ul>li]:before:absolute [&_ul>li]:before:left-0 [&_ul>li]:before:text-[var(--color-primary-600)] [&_ul>li]:before:dark:text-[var(--color-primary-400)] [&_ul>li]:before:font-bold",
          // 有序列表项样式 - 修复计数器
          ...
          "[&_ol>li]:[counter-increment:item] [&_ol>li]:before:[content:counter(item)'.'] [&_ol>li]:before:absolute [&_ol>li]:before:left-0 [&_ol>li]:before:text-[var(--color-primary-600)] [&_ol>li]:before:dark:text-[var(--color-primary-400)] [&_ol>li]:before:font-semibold",
          // 嵌套列表
          "[&_ul_ul]:mt-2 [&_ul_ul]:mb-0",
          "[&_ol_ol]:mt-2 [&_ol_ol]:mb-0 [&_ol_ol]:[counter-reset:item]", // 嵌套列表也重置计数器
          "[&_ul_ul>li]:before:content-['◦'] [&_ul_ul>li]:before:text-sm",
          "[&_ul_ul_ul>li]:before:content-['▪'] [&_ul_ul_ul>li]:before:text-xs",
          // 引用样式
          "[&_blockquote]:border-l-4 [&_blockquote]:border-[var(--color-primary-500)] [&_blockquote]:pl-4 [&_blockquote]:py-2 [&_blockquote]:my-4 [&_blockquote]:italic [&_blockquote]:text-[var(--color-gray-700)] [&_blockquote]:dark:text-[var(--color-gray-300)]",
          // 行内代码样式
